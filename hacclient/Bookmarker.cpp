...
ServerBookmark::operator ServerInformation() {
	...
	ServerInformation info(ip, atoi(port.c_str()));
...
unsigned int __stdcall Bookmarker::query(void* o) {
	...
	//Parse string - refactor class and hooks to take ServerInformation
